...
public class NewNotesActivity extends AppCompatActivity {
        ...
        private Button olusturmabutonu;
...
//metnin içindeki boşluklardan kurtulmak için trim kullanılır.
            ...
            olusturmabutonu = (Button) findViewById(R.id.new_note_btn);
            ...
            olusturmabutonu.setOnClickListener(new View.OnClickListener() {
                @Override
                            ...
                            newNoteRef.setValue(noteMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(NewNotesActivity.this, "Not database'e eklendi.", Toast.LENGTH_SHORT).show();
                                    } else {
        ...
        private void deleteNote() {
            ...
            fNotesDatabase.child(noteID).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(NewNotesActivity.this, "Not silindi.", Toast.LENGTH_SHORT).show();
                        noteID = "no";
                        finish();
                    } else {
                        Log.e("NewNoteActivity", task.getException().toString());
                        Toast.makeText(NewNotesActivity.this, "Hata: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
